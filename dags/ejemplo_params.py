...
with DAG(
    ...
    tags=['Ejemplo',"Lautaro" ,'Params'], # estos apareceran debajo del DAG en la plataforma
    schedule_interval="@daily") as dag:
    task1= BashOperator(task_id='primera_tarea',
    bash_command='echo Primer tarea mi nombre es Lautaro!'
    )

    task2 =BashOperator(
        task_id='segunda_tarea',
        bash_command="echo Segunda tarea completada soy Ingeniero de datos"
    )
